        ...
        <el-tabs :tab-position="'left'" v-model="activeName" :before-leave="beforeTabLeave" @tab-click="tabClick">
          <el-tab-pane name="0" label="基本信息">
            ...
            <el-form-item label="商品分类" prop="goods_cat">
              <el-cascader v-model="addForm.goods_cat" :options="selectCateList" :props="selectCateProps" clearable @change="handleChange"></el-cascader>
            </el-form-item>
          </el-tab-pane>
          <el-tab-pane name="1" label="商品参数">
            <el-form-item :label="item.attr_name" v-for="item in manyCateData" :key="item.attr_id">
              <el-checkbox-group v-model="item.attr_vals">
                <el-checkbox border :label="j" v-for="(j, i) in item.attr_vals" :key="i"></el-checkbox>
              </el-checkbox-group>
            </el-form-item>
          </el-tab-pane>
          ...
          <el-tab-pane name="3" label="商品图片">
            <el-upload class="upload-demo" :action="uploadURL" :on-preview="handlePreview" :on-remove="handleRemove" :on-success="handleSuccess" :headers="headerObj" list-type="picture">
